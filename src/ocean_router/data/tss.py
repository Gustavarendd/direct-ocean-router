...
class TSSFields:
    ...
    def alignment_penalty(
        ...
        max_lane_deviation_deg: float = 100.0,
    ) -> float:
    ...
    def line_goes_wrong_way(self, y0: int, x0: int, y1: int, x1: int) -> bool:
        ...
        move_bearing = math.degrees(math.atan2(dx_total, -dy_total)) % 360
